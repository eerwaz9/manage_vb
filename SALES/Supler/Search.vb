Public Class Search
    ...
    Private Sub DataGridView1_Click(sender As Object, e As EventArgs) Handles DataGridView1.Click
        If DataGridView1(0, DataGridView1.CurrentRow.Index).Selected = True Then
            SUPLIER.SHOW_DETALLES(DataGridView1.CurrentRow.Cells(1).Value)
            DEBIT.SHOWS_DETALLES(DataGridView1.CurrentRow.Cells(1).Value)
            acount.SHOWS_DETALLES(DataGridView1.CurrentRow.Cells(1).Value)
            Me.Close()
        End If
