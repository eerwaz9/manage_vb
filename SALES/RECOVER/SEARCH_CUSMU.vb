Public Class SEARCH_CUSMU
    Private Sub SEARCH_CUSMU_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub DataGridView1_Click(sender As Object, e As EventArgs) Handles DataGridView1.Click
        If DataGridView1(0, DataGridView1.CurrentRow.Index).Selected = True Then
            RECOVER.ReCUSTOMERNAME.Text = DataGridView1.CurrentRow.Cells(2).Value
            RECOVER.CUS_CODE.Text = DataGridView1.CurrentRow.Cells(1).Value
            Me.Close()
        End If
        If SHOW_FROM = "1شاشة الزبائن " Then
            RECOVER.ReCUSTOMERNAME.Text = DataGridView1.CurrentRow.Cells(2).Value
            RECOVER.CUS_CODE.Text = DataGridView1.CurrentRow.Cells(1).Value
            Me.Close()
        End If
        ...
        If SHOW_FROM = "شاشة الزبائن3" Then
