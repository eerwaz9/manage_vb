Public Class SEARCH_IMP
    Private Sub SEARCH_IMP_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub DataGridView1_Click(sender As Object, e As EventArgs) Handles DataGridView1.Click
        If DataGridView1(0, DataGridView1.CurrentRow.Index).Selected = True Then
            SELLEPILL.IMPORTERS.Text = DataGridView1.CurrentRow.Cells(2).Value
            SELLEPILL.IMP_CODE.Text = DataGridView1.CurrentRow.Cells(1).Value
            Me.Close()
        End If
    End Sub
