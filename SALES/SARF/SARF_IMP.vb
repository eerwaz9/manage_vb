Public Class SARF_IMP
    Private Sub SARF_IMP_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub DataGridView1_Click(sender As Object, e As EventArgs) Handles DataGridView1.Click
        If DataGridView1(0, DataGridView1.CurrentRow.Index).Selected = True Then
            SARF.IMP_NAME.Text = (DataGridView1.CurrentRow.Cells(2).Value)
            SARF.IMP_CODE.Text = (DataGridView1.CurrentRow.Cells(1).Value)
            Me.Close()
        End If
