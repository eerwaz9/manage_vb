...
Public Class RuPUT_BILL
    ...
    Private Sub ButtSave_Click(sender As Object, e As EventArgs) Handles ButtSave.Click
        ...
        Dim DR_ = DT_.NewRow
        DR_!PUYCODE = ReSALECODE.Text
        DR_!PUYDATE = ReSALEDATE.Value
        DR_!DESCRIPTION = "فاتور استرجاع المشتريات رقم " & ReSALECODE.Text
        DR_!DEBIT = "0"
        DR_!CERDIT = Val(TOTAL.Text)
        DR_!IMP_NAME = RuIMPORTERS.Text
        DR_!IMP_CODE = RuIMPORTERS.Text
        DT_.Rows.Add(DR_)
    ...
    Private Sub ButtEdite_Click(sender As Object, e As EventArgs) Handles ButtEdite.Click
        ...
        '============حذف تفاصيل الفاتورة اولا ثم اضافتها
        ...
        '==========================================
        CMD_DEL = New SqlClient.SqlCommand
        CMD_DEL.Connection = sqlconnt
        CMD_DEL.CommandText = "DELETE FROM  DET_IMPORTERS WHERE PUYCODE ='" & ReSALECODE.Text & "' "
        CMD_DEL.ExecuteNonQuery()
        '===========حركة الموردين
        Dim DTA As New SqlClient.SqlDataAdapter("Select * from DET_IMPORTERS ", sqlconnt)
        Dim DASET As New DataSet
    ...
    Private Sub ReCUSTOMERNAME_SelectedIndexChanged(sender As Object, e As EventArgs)
